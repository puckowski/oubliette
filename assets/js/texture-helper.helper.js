...
import { TextureLoader, PlaneGeometry, MeshBasicMaterial, MeshPhongMaterial, BoxGeometry, Mesh } from './threemodule';
...
export class TextureHelper {
    ...
    buildMonsterTextures(monsterTextureMap, animators) {
        ...
        const animDragonTexture = new  TextureLoader().load(animDragonTexturePath)
        const dragonAnimator =  new  PlainAnimator(animDragonTexture, 10, 14, 140, 10);
        const animDragonTextureFinal = dragonAnimator.init();  

        const animDragonGeometry = new PlaneGeometry(150, 150);
        const animDragon1Material = new MeshBasicMaterial({
        ...
        const animDragon2Texture = new  TextureLoader().load(animDragon2TexturePath)
        const dragon2Animator =  new  PlainAnimator(animDragon2Texture, 2, 2, 4, 4);
        const animDragonTexture2Final = dragon2Animator.init();  

        const animDragon2Geometry = new PlaneGeometry(100, 100);
        const animDragon2Material = new MeshBasicMaterial({
        ...
        const animDemonTexture = new  TextureLoader().load(animDemonTexturePath)
        const demonAnimator =  new  PlainAnimator(animDemonTexture, 1, 18, 18, 10);
        const animDemonTextureFinal = demonAnimator.init();  

        const animDemonGeometry = new PlaneGeometry(100, 100);
        const animDemon1Material = new MeshBasicMaterial({
        ...
        const animOrcTexture = new  TextureLoader().load(animOrcTexturePath)
        const orcAnimator =  new  PlainAnimator(animOrcTexture, 1, 7, 7, 7);
        const animOrcTextureFinal = orcAnimator.init();  

        const animOrcGeometry = new PlaneGeometry(80, 80);
        const animOrc1Material = new MeshBasicMaterial({
        ...
        const animOrc2Texture = new  TextureLoader().load(animOrc2TexturePath)
        const orc2Animator =  new  PlainAnimator(animOrc2Texture, 1, 7, 7, 7);
        const animOrc2TextureFinal = orc2Animator.init();  

        const animOrc2Geometry = new PlaneGeometry(80, 80);
        const animOrc2Material = new MeshBasicMaterial({
        ...
        const animOrc3Texture = new  TextureLoader().load(animOrc3TexturePath)
        const orc3Animator =  new  PlainAnimator(animOrc3Texture, 1, 10, 10, 10);
        const animOrc3TextureFinal = orc3Animator.init();  

        const animOrc3Geometry = new PlaneGeometry(80, 80);
        const animOrc3Material = new MeshBasicMaterial({
        ...
        const animOrc4Texture = new  TextureLoader().load(animOrc4TexturePath)
        const orc4Animator =  new  PlainAnimator(animOrc4Texture, 1, 8, 8, 8);
        const animOrc4TextureFinal = orc4Animator.init();  

        const animOrc4Geometry = new PlaneGeometry(80, 80);
        const animOrc4Material = new MeshBasicMaterial({
        ...
        const animWizardTexture = new  TextureLoader().load(animWizardTexturePath)
        const wizardAnimator =  new  PlainAnimator(animWizardTexture, 1, 5, 5, 5);
        const animWizardTextureFinal = wizardAnimator.init();  

        const animWizardGeometry = new PlaneGeometry(80, 80);
        const animWizardMaterial = new MeshBasicMaterial({
        ...
        const animWizard2Texture = new  TextureLoader().load(animWizard2TexturePath)
        const wizard2Animator =  new  PlainAnimator(animWizard2Texture, 1, 5, 5, 5);
        const animWizard2TextureFinal = wizard2Animator.init();  

        const animWizard2Geometry = new PlaneGeometry(80, 80);
        const animWizard2Material = new MeshBasicMaterial({
        ...
        const animSkeletonTexture = new  TextureLoader().load(animSkeletonTexturePath)
        const skeletonAnimator =  new  PlainAnimator(animSkeletonTexture, 1, 8, 8, 8);
        const animSkeletonTextureFinal = skeletonAnimator.init();  

        const animSkeletonGeometry = new PlaneGeometry(100, 100);
        const animSkeletonMaterial = new MeshBasicMaterial({
        ...
        const animReaperTexture = new  TextureLoader().load(animReaperTexturePath)
        const reaperAnimator =  new  PlainAnimator(animReaperTexture, 1, 8, 8, 8);
        const animReaperTextureFinal = reaperAnimator.init();  

        const animReaperGeometry = new PlaneGeometry(80, 80);
        const animReaperMaterial = new MeshBasicMaterial({
        ...
        const ratGeometry = new PlaneGeometry(100, 50);
        const rat1Material = new MeshPhongMaterial({
        ...
        const reaperGeometry = new PlaneGeometry(80, 80);
        const reaper1Material = new MeshPhongMaterial({
        ...
        const dragonGeometry = new PlaneGeometry(100, 100);
        const dragon1Material = new MeshPhongMaterial({
        ...
        const dragon2Material = new MeshPhongMaterial({
    ...
    buildFloorTextures(floorTextureMap) {
        ...
        const floorGeometry = new BoxGeometry(this.platformWidth, 5, this.platformHeight);
        
        const floor1Material = new Mesh(floorGeometry, new MeshPhongMaterial({
        ...
        const dirt1Material = new Mesh(floorGeometry, new MeshPhongMaterial({
        ...
        const dirt2Material = new Mesh(floorGeometry, new MeshPhongMaterial({
        ...
        const grass1Material = new Mesh(floorGeometry, new MeshPhongMaterial({
        ...
        const grass2Material = new Mesh(floorGeometry, new MeshPhongMaterial({
        ...
        const stone1Material = new Mesh(floorGeometry, new MeshPhongMaterial({
        ...
        const stone2Material = new Mesh(floorGeometry, new MeshPhongMaterial({
    ...
    buildSkyTextures(skyTextureMap) {
        ...
        const skyGeometry = new BoxGeometry(this.platformWidth, 5, this.platformHeight);

        const sky1Material = new Mesh(skyGeometry, new MeshPhongMaterial({
    ...
    buildWallTextures(wallTextureMap, animators) {
        ...
        const torchTexture = new  TextureLoader().load(torchTexturePath)
        const torchAnimator =  new  PlainAnimator(torchTexture, 9, 1, 9, 15);
        const torchTextureFinal = torchAnimator.init();  

        const torchGeometry = new PlaneGeometry(25, 25);
        const torch1Material = new MeshBasicMaterial({
        ...
        const animMan1Texture = new  TextureLoader().load(animMan1TexturePath)
        const animMan1Animator =  new  PlainAnimator(animMan1Texture, 5, 2, 10, 10);
        const animMan1TextureFinal = animMan1Animator.init();  

        const animMan1Geometry = new PlaneGeometry(80, 80);
        const animMan1Material = new MeshBasicMaterial({
        ...
        const animWoman1Texture = new  TextureLoader().load(animWoman1TexturePath)
        ...
        const animWoman1Geometry = new PlaneGeometry(80, 80);
        const animWoman1Material = new MeshBasicMaterial({
        ...
        const animWoman2Texture = new  TextureLoader().load(animWoman2TexturePath)
        ...
        const animWoman2Geometry = new PlaneGeometry(80, 80);
        const animWoman2Material = new MeshBasicMaterial({
        ...
        const animMan2Texture = new  TextureLoader().load(animMan2TexturePath)
        const animMan2Animator =  new  PlainAnimator(animMan2Texture, 10, 1, 10, 10);
        const animMan2TextureFinal = animMan2Animator.init();  

        const animMan2Geometry = new PlaneGeometry(80, 80);
        const animMan2Material = new MeshBasicMaterial({
        ...
        const animMan3Texture = new  TextureLoader().load(animMan3TexturePath)
        const animMan3Animator =  new  PlainAnimator(animMan3Texture, 10, 1, 10, 10);
        const animMan3TextureFinal = animMan3Animator.init();  

        const animMan3Geometry = new PlaneGeometry(80, 100);
        const animMan3Material = new MeshBasicMaterial({
        ...
        const accentGeometry = new PlaneGeometry(50, 50);
        const bush1Material = new MeshBasicMaterial({
        ...
        const bush2Material = new MeshBasicMaterial({
        ...
        const bush3Material = new MeshBasicMaterial({
        ...
        const sign1Material = new MeshBasicMaterial({
        ...
        const sign2Material = new MeshBasicMaterial({
        ...
        const brick1Material = new MeshPhongMaterial({
        ...
        const teleport1Material = new MeshPhongMaterial({
        ...
        const forest7Material = new MeshPhongMaterial({
        ...
        const forest8Material = new MeshPhongMaterial({
        ...
        const stone1Material = new MeshPhongMaterial({
        ...
        const stone2Material = new MeshPhongMaterial({
        ...
        const stone6Material = new MeshPhongMaterial({
        ...
        const ruins1Material = new MeshPhongMaterial({
        ...
        const tableGeometry = new PlaneGeometry(50, 50);
        const table1Material = new MeshBasicMaterial({
        ...
        const woman2Material = new MeshBasicMaterial({
